...
#YES Does the analysis include description and justification for any data transformations?
#YES Does the document have a title that briefly summarizes the data analysis?
#YES Does the document have a synopsis that describes and summarizes the data analysis in less than 10 sentences?
#YES Is there a section titled "Data Processing" that describes how the data were loaded into R and processed for analysis?
#YES Is there a section titled "Results" where the main results are presented?
#Yes Is there at least one figure in the document that contains a plot?
#YEs Are there at most 3 figures in this document? 3 figures >> fetality, injuries, total economic damage
#YES Does the analysis start from the raw data file (i.e. the original .csv.bz2 file)?
#YES Does the analysis address the question of which types of events are most harmful to population health?
#YES Does the analysis address the question of which types of events have the greatest economic consequences?
